    ...
    <main class="app-main">
      <div class="app-content-header">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <h3 class="mb-0">Kontrol Paneli</h3>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-3 col-6">
              <div class="small-box text-bg-primary">
                ...
                <a href="#" class="small-box-footer">Daha fazla bilgi <i class="bi bi-link-45deg"></i></a>
              </div>
            </div>
            <div class="col-lg-3 col-6">
            ...
            <section class="col-lg-5 connectedSortable">
              <div class="card bg-primary bg-gradient text-white mb-4">
                <div class="card-header border-0">
                  <h3 class="card-title">Dünya Haritası</h3>
                </div>
                <div class="card-body">
